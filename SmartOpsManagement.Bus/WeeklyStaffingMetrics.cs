...
/// <summary>
/// Business logic for WeeklyStaffingMetrics operations.
/// </summary>
public partial class SmartOpsBusinessLogic
{
    ...
    public async Task<WeeklyStaffingMetrics> GetWeeklyStaffingMetricsAsync(
        DateTime weekStart,
        ...
        int? clientId = null)
    {
        ...
        return new WeeklyStaffingMetrics
        {
            WeekStart = weekStart,
