...
The UI would be in the #file:'D:\Code\Git\MadisonDecker\TimeManagement Solution\SmartShift.Blazor\SmartShift.Blazor\SmartShift.Blazor.csproj' project. But this UI would also include a default view that would be the employees schedule view. A second view based on AD membership would hold all the workforcemanagement for that supervisor.
