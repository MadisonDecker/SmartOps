    ...
    public static List<ScheduleRecord> GetSchedules(DateTime shiftStartDate, DateTime shiftEndDate)
    {
        ...
        while (reader.Read())
        {
            results.Add(new ScheduleRecord
            {
                ...
                EmplId = reader.IsDBNull(reader.GetOrdinal("EMPLID")) ? null : reader.GetInt32(reader.GetOrdinal("EMPLID")),
                FileNumber = reader.IsDBNull(reader.GetOrdinal("FILE_NUMBER")) ? null : reader.GetInt32(reader.GetOrdinal("FILE_NUMBER")),
