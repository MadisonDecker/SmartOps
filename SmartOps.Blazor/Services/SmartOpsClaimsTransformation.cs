...
/// </summary>
public class SmartOpsClaimsTransformation : IClaimsTransformation
{
    private readonly ILogger<SmartOpsClaimsTransformation> _logger;
    private readonly RoleOptions _options;

    public SmartOpsClaimsTransformation(
        ILogger<SmartOpsClaimsTransformation> logger,
